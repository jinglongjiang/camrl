...
def main():
    ...
    parser.add_argument('--policy', type=str, default='sarl', help='Policy name (only sarl supported)')
    parser.add_argument('--model_dir', type=str, default='runs/mamba_vl', help='Model directory')
    parser.add_argument('--weights', type=str, default='rl_model_sarl.pth', help='Checkpoint name or "latest"')
    ...
    print("[INFO] ========================================")
    print("[INFO] TEST2.PY - SARL Baseline Testing")
    print("[INFO] ========================================")
    ...
    for case_idx, case in enumerate(test_cases):
        ...
        # ========================================
        # SARL POLICY LOADING (test2.py specific)
        # ========================================
        try:
            print(f"[INFO] Loading SARL policy")
            ...
            print(f"[ERROR] SARL initialization failed: {e}")
            raise
