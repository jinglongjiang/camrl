...
def main():
    ...
    parser.add_argument("--policy", type=str, default="orca", help="Policy name (only orca supported)")
    parser.add_argument("--model_dir", type=str, default=None, help="Not used for ORCA")
    parser.add_argument("--weights", type=str, default=None, help="Not used for ORCA")
    ...
    print("[INFO] ========================================")
    print("[INFO] TEST5.PY - ORCA Baseline Testing")
    print("[INFO] ========================================")
    print("[INFO] Config: T=12, dt=0.25, v_max=1.0 (MATCHED TO TRAINING)")
    print("[INFO] Feature: Classical collision avoidance (no learning)")
    ...
    for case_idx, case in enumerate(test_cases):
        ...
        # ========================================
        # ORCA POLICY LOADING (test5.py specific)
        # ========================================
        print(f"[INFO] Loading ORCA policy")
        from crowd_nav.policy.orca_wrapper import ORCA_WRAPPER
        policy = ORCA_WRAPPER()
        # ORCA doesn't need configure
        print(f"[DEBUG] Policy Class: {type(policy)}")

        # ORCA doesn't need weights, device, or phase
