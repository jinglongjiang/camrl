...
# The evaluation protocol lives in evaluation_protocol.py. Re-exported here
# only so existing evaluation call sites keep working; TRAINING never reads
# these -- it knows its training and validation seeds and nothing else.
