"""Split from selftest.py (guide/review point 1): FEATURE_SCHEMA_V5 feature-batch, checkpoint, and score_candidates_v5 tests. Shares the
...
def test_intent_policy_feature_batch_shape_and_finite() -> None:
    ...
    assert feat.shape == (20, HUMAN_FEATURE_DIM_V5)
